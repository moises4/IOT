...
images = csvread('C:\Users\dhg5054.PSU-ERIE\Downloads\TrainWavelet (1).csv');
targets = images(:,1);
...
sweep = [100:50:1000];                 % parameter values to test
...
saveas(fig, 'db_NN_training_sweep_25_25_576_take2.png')